...
namespace ClashofClans.Logic.Manager.Items.GameObjects
{
	public class Building : GameObject
	{
		...
		public ResourceStorageComponent ResourceStorageComponent =>
			TryGetComponent(6, out Component component) ? (ResourceStorageComponent)component : null;
		...
		public void StartUpgrade()
		{
			...
			int buildTime = BuildingData.GetBuildTime(_upgradeLevel + 1);
		...
		public void SetUpgradeLevel(int upgradeLevel)
		{
			...
			ResourceProductionComponent resourceProductionComponent = ResourceProductionComponent;
		...
		public override void Load(JObject jObject)
		{
			...
			{
				int boostTime = jObject["boost_t"].ToObject<int>();
				if (boostTime > -1)
				{
					BoostTimer = new Timer();
