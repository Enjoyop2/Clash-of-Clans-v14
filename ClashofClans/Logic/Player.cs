...
namespace ClashofClans.Logic
{
	public class Player
	{
		...
		public void LogicClientAvatar(ByteBuffer packet)
		{
			...
			foreach (Unit machine in Home.Units.SiegeMachines)
			{
			...
			foreach (Unit pet in Home.Units.Pets)
			{
			...
			int mission = Home.NameSet == 0 ? 10 : 150;
			...
			foreach (int playerLabel in Home.PlayerLabels)
			{
