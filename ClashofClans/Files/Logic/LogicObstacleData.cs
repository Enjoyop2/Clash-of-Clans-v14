...
namespace ClashofClans.Files.Logic
{
	...
	{
		public LogicObstacleData(Row row, DataTable datatable) : base(row, datatable)
		{
		...
		public string SelectedExportName { get; protected set; }
		public int CollectLootOnSelect { get; protected set; }
		public int FadeTimeMS { get; protected set; }
	}
}